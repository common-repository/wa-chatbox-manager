            ...
            <div class="notice notice-warning is-dismissible chatbox_manager_notice">
            	...
            	<p>
					...
					<p class="notice-coupon-message">
						...
						<?php esc_html_e( 'Unlock a 50% discount on all plans now! Use the limited-time coupon code', 'chatbox-manager' ); ?>
						<strong><?php esc_html_e( 'CHATBOXMANAGER50', 'chatbox-manager' ); ?></strong>
